...
button.addEventListener("click",function(){
    ...
    if(parseInt(nighttime.value)===hours){
        ...
        document.getElementById("changeImageOnTime").src = './image/goodNight.png';
    }
